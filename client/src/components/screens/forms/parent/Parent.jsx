		...
		<div className='parentFormContainer'>
			<div className='flex justify-center items-center h-auto '>
				<form
					...
					<input
						type='text'
						placeholder='Child School'
						{...register('child school', { required: true })}
					...
					<input
						...
						className='shadow rounded-lg w-3/6 mr-5 border-2 border-gray-500 h-12 mb-3 bg-white'
					/>
					<input
						type='text'
